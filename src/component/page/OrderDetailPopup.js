...
const OrderDetailPopup = ({ module, isOpen, onClose }) => {

    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-20">
            <div className="bg-white p-6 rounded-md shadow-lg w-3/4 max-h-[90vh] overflow-y-auto">
                <h2 className="text-2xl font-bold mb-1">Chi tiết đơn hàng</h2>
                <h2 className="text-md font-md mb-4">Ngày: {castDate(module.createdAt || '')}</h2>
